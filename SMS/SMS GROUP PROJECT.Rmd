...
We fit the model that have been transformed. The qq-plot of residuals scatter around the line but closer than in previous model. The regularity and  funnel shape in residual vs fitted plot imply that decreasing variance as original target value getting bigger (i.e.: smaller transformed value).
...
We could use decision tree which is not the main focus of statistical modelling but it worth a try.
